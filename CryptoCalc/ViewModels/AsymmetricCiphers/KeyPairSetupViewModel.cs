...
namespace CryptoCalc
{
    ...
    public class KeyPairSetupViewModel : BaseViewModel
    {
        ...
        private void GetOtherPublicKeyFilePath()
        {
            ...
            OtherPartyPublicKeyFilePath = DI.Application.FilePathFromDialogSelection;
        }
        ...
        private void GetPrivateKeyFilePath()
        {
            ...
            //Saves the selected path
            PrivateKeyFilePath = DI.Application.FilePathFromDialogSelection;
        ...
        private void GetPublicKeyFilePath()
        {
            ...
            //Saves the selected path
            PublicKeyFilePath = DI.Application.FilePathFromDialogSelection;
